...
class TestIocDedupStore:
    ...
    def test_domain_normalization(self, store) -> None:
    ...
    def test_contains(self, store) -> None:
    ...
    def test_get_by_type(self, store) -> None:
    ...
    def test_advance_sprint(self, store) -> None:
        """Advance to new sprint."""
        store.add("evil.com", "domain", 0.9)
        store.advance_sprint(2)
        assert store.get_sprint() == 2

    def test_batch_add(self, store) -> None:
...
class TestIocDedupPersistence:
    ...
    def test_to_bytes_and_restore(self) -> None:
...
class TestIocDedupManager:
    ...
    def test_manager_add(self, tmp_path) -> None:
    ...
    def test_manager_persistence(self, tmp_path) -> None:
    ...
    def test_manager_advance_sprint(self, tmp_path) -> None:
    ...
    def test_fallback_on_invalid_data(self, tmp_path) -> None:
