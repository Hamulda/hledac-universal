...
class TestSourceBaselinesReal:
    ...
    def test_no_local_baselines_in_compute_confidence(self):
        """
    ...
    def test_source_baselines_values_match_constants(self):
    ...
    def test_ast_no_baselines_assignment_in_function(self):
...
class TestClaimsCoordinatorMigration:
    ...
    def test_imports_compute_confidence(self):
    ...
    def test_derive_confidence_calls_compute_confidence(self):
    ...
    def test_derive_confidence_respects_max_confidence_075(self):
    ...
    def test_provenance_raises_claims_confidence(self):
    ...
    def test_url_domain_email_raises_claims_confidence(self):
    ...
    def test_ct_baseline_higher_than_public(self):
    ...
    def test_all_outputs_bounded(self):
        ...
        from hledac.universal.coordinators.claims_coordinator import ClaimsCoordinator
        from intelligence.confidence_policy import MIN_CONFIDENCE, MAX_CONFIDENCE
        coord = ClaimsCoordinator()
    ...
    def test_no_mlx_in_claims_coordinator(self):
    ...
    def test_no_duckdb_import_at_module_level(self):
...
class TestSocialIdentityMinerMigration:
    ...
    def test_compute_confidence_calls_policy(self):
    ...
    def test_social_min_confidence_threshold_preserved(self):
    ...
    def test_no_mlx_in_social_identity_miner(self):
...
class TestRegression:
    ...
    def test_claims_coordinator_still_initializable(self):
    ...
    def test_social_identity_miner_still_initializable(self):
    ...
    def test_confidence_policy_imports_clean(self):
