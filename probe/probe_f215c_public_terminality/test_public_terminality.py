...
class TestPublicTerminalStateDerivation:
    ...
    def test_raw_none_returns_never_scheduled(self) -> None:
    ...
    def test_raw_none_preserves_skip_reason(self) -> None:
    ...
    def test_attempted_with_error_returns_attempted_error(self) -> None:
        """attempted=True + error → ATTEMPTED_ERROR."""
        result = normalize_source_family_outcome(
            "public",
            {
                "attempted": True,
                "skipped": False,
    ...
    def test_attempted_with_timeout_returns_attempted_timeout(self) -> None:
    ...
    def test_attempted_with_accepted_findings_returns_attempted_accepted(self) -> None:
    ...
    def test_attempted_zero_results_returns_attempted_no_results(self) -> None:
    ...
    def test_attempted_zero_results_with_discovered_returns_no_results(self) -> None:
    ...
    def test_skipped_by_policy_returns_skipped_by_policy(self) -> None:
    ...
    def test_skipped_by_memory_returns_skipped_by_memory(self) -> None:
    ...
    def test_skipped_by_remaining_low_returns_skipped(self) -> None:
    ...
    def test_skipped_no_skip_reason_returns_skipped(self) -> None:
    ...
    def test_feed_tuple_returns_attempted(self) -> None:
    ...
    def test_acquisition_lane_outcome_to_dict(self) -> None:
...
class TestSourceFamilyOutcomeTerminalState:
    ...
    def test_to_dict_includes_terminal_state(self) -> None:
    ...
    def test_to_dict_terminal_state_round_trip(self) -> None:
    ...
    def test_terminal_state_default_is_unknown(self) -> None:
...
class TestPublicTerminalStateCanonical:
    ...
    def test_normalize_public_outcome_has_terminal_state(self) -> None:
        ...
        outcomes = [
            ...
            # TaskGroup error
            {
                ...
                "built_count": 0,
                "accepted_count": 0,
                "error": "TaskGroup: ExceptionGroup",
                "timeout": False,
                "duration_s": None,
            },
            # generic exception
    ...
    def test_all_defined_terminal_states_covered(self) -> None:
        ...
        cases = [
            ...
            (
                {"attempted": True, "skipped": False, "error": "oops", "timeout": False, "accepted_count": 0},
                "ATTEMPTED_ERROR",
            ),
            (
                {"attempted": True, "skipped": False, "error": None, "timeout": True, "accepted_count": 0},
                "ATTEMPTED_TIMEOUT",
            ),
            (
                {"attempted": True, "skipped": False, "error": None, "timeout": False, "accepted_count": 3},
                "ATTEMPTED_ACCEPTED",
            ),
            (
                {"attempted": True, "skipped": False, "error": None, "timeout": False, "accepted_count": 0},
