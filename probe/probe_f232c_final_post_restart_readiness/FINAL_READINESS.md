...
**Detail:** swap=8.000GiB > 4.0GiB — restart required

### Blockers

- **memory** (HARD_BLOCK): swap=8.000GiB > 4.0GiB threshold (hard_block tier)
  - swap=8.000GiB (threshold=4.0GiB)
...
| swap_gate_reason | swap=8.000GiB > 4.0GiB |
...
- BLOCKED_BY_MEMORY: swap=6.61GiB > 4.0GiB — restart required
...
- provider_surface_ok=False
- swap_used=8.000GiB uma_state=unknown
