...
class TaskPrioritizerWrapper:
    ...
    """
    __slots__ = tuple(('model', 'model_path', 'optimizer', 'trained', 'update_counter'))
    ...
    def extract_features(self, task_metadata: dict):
        ...
        source_type_map = {'feed': 0.1, 'cert': 0.3, 'dns': 0.2, 'scrape': 0.4, 'archive': 0.5, 'api': 0.6, 'ct': 0.7, 'pubsub': 0.8, 'leak': 0.9, 'breach': 0.85}
        ...
        features = [priority, estimated_duration, complexity, source_type, entity_count, novelty, contradiction_score, centrality, historical_gain, historical_duration]
