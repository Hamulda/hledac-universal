...
class RobotsParser:
    ...
    __slots__ = ("_cache", "_cache_access_time", "_max_cache_size", "_session", "_user_agent", "cache_ttl")

    def __init__(self, cache_ttl: float = _DEFAULT_TTL_SECONDS, max_cache_size: int = _MAX_CACHE_SIZE) -> None:
        """
