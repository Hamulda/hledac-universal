...
class ImportOptimizer:
    ...
    __slots__ = ("check_only", "dry_run", "files_with_issues")

    def __init__(self, check_only: bool = False, dry_run: bool = False) -> None:
...
def main() -> None:
    ...
    parser.add_argument(
        "--check-only", action="store_true", help="Check if files need fixing (exit code 1 if issues found)"
    )
