...
class LSHNearDuplicateDetector:
    ...
    __slots__ = ("_documents", "_index", "_lock", "_stats", "max_results", "num_rows", "num_tables", "threshold")
    ...
    def __init__(
        ...
        logger.debug(
            f"LSHNearDuplicateDetector initialized: tables={num_tables}, rows={num_rows}, threshold={threshold}"
        )
    ...
    def add_document(self, doc_id: str, text: str) -> bool:
        ...
        with self._lock:
            ...
            for cand_id, _similarity in candidates:
