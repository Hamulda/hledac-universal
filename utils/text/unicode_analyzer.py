...
class UnicodeAttackAnalyzer:
    ...
    def _load_confusable_mappings(self) -> None:
        ...
        raw_map: dict[str, list[str]] = {
            ...
            'o': ['о', 'О', 'ò', 'ó', 'ô', 'õ', 'ö', 'ø', 'ō', 'ŏ', 'ő', 'ơ', 'ọ', 'ỏ', 'ố', 'ồ', 'ổ', 'ỗ', 'ộ', 'ớ', 'ờ', 'ở', 'ỡ', 'ợ', 'ο', 'σ', 'օ'],  # noqa: E501
            'p': ['р', 'ṕ', 'ṗ', 'ρ', 'ϱ', 'Þ', 'þ'],
            'q': ['ԛ', 'ɋ', 'ʠ'],
            ...
            'O': ['О', 'Ò', 'Ó', 'Ô', 'Õ', 'Ö', 'Ø', 'Ō', 'Ŏ', 'Ő', 'Ơ', 'Ǒ', 'Ǫ', 'Ǭ', 'Ȍ', 'Ȏ', 'Ȫ', 'Ȭ', 'Ȯ', 'Ȱ', 'Ṍ', 'Ṏ', 'Ṑ', 'Ṓ', 'Ọ', 'Ỏ', 'Ố', 'Ồ', 'Ổ', 'Ỗ', 'Ộ', 'Ớ', 'Ờ', 'Ở', 'Ỡ', 'Ợ', 'Θ', 'Ο', 'Ό', 'Ὸ'],  # noqa: E501
            'P': ['Р', 'Ṕ', 'Ṗ', 'Ρ', 'Ῥ', 'Þ'],
            'Q': ['Ԛ'],
            'R': ['Ŕ', 'Ŗ', 'Ř', 'Ȑ', 'Ȓ', 'Ṙ', 'Ṛ', 'Ṝ', 'Ṟ', 'Ṟ', 'Я', 'Г', 'Ρ'],
            'S': ['Ѕ', 'Ś', 'Ŝ', 'Ş', 'Š', 'Ș', 'Ṡ', 'Ṣ', 'Ṥ', 'Ṧ', 'Ṩ', 'Ş', '§', '$'],
            'T': ['Т', 'Ţ', 'Ť', 'Ŧ', 'Ț', 'Ṫ', 'Ṭ', 'Ṯ', 'Ṱ', 'Τ', 'Т'],
            'U': ['υ', 'Ù', 'Ú', 'Û', 'Ü', 'Ũ', 'Ū', 'Ŭ', 'Ů', 'Ű', 'Ų', 'Ư', 'Ǔ', 'Ǖ', 'Ǘ', 'Ǚ', 'Ǜ', 'Ȕ', 'Ȗ', 'Ṳ', 'Ṵ', 'Ṷ', 'Ṹ', 'Ṻ', 'Ụ', 'Ủ', 'Ứ', 'Ừ', 'Ử', 'Ữ', 'Ự', 'Ʊ', 'Ս'],  # noqa: E501
            'V': ['Ṽ', 'Ṿ', 'ν', 'Ѵ', 'Ѷ', 'Ⅴ'],
