...
class DiagnosticsEngine:
    ...
    def __init__(
        self, *, enable_auto_diagnostics: bool = False, diagnostic_interval: int = 60, m1_optimization: bool = True
    ) -> None:
        raise ImportError(
            "DiagnosticsEngine requires additional monitoring dependencies — this component was not migrated to the current codebase"
        )
