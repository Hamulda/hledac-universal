...
WHEEL_REPORT_PACKAGES: List[Dict[str, str]] = [
    ...
    {"name": "pyprobables", "spec": "pyprobables>=4.0.0", "extra": "default"},
    {"name": "pyzipper", "spec": "pyzipper>=1.4.0", "extra": "default"},
