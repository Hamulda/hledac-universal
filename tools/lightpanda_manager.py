...
class LightpandaManager:
    ...
    __slots__ = ("_bin_path", "_endpoint", "_proc")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if not expected_hash:
                    raise ValueError(
                        "[LIGHTPANDA] LIGHTPANDA_SHA256 env var must be set to verify binary integrity before download. Set it to the trusted SHA256 hash."
                    )
