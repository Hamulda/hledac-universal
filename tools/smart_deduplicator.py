...
class SmartDeduplicator:
    ...
    __slots__ = ("delta", "hasher", "logger", "max_text_size", "min_savings_bytes", "near_dup_threshold")
    ...
    def maybe_store_delta(
        self, url: str, base_text: str, new_text: str, store_cb: Callable[[str, str, bytes], str]
    ) -> dict:
        """
