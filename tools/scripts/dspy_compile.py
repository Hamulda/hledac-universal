...
OSINT_DARK_QUERY_TRAINSET = [
    ...
    dspy.Example(
        ...
        available_transports="tor+stealth",
        max_queries=5,
        dark_queries=[
            {"type": "onion", "query": "ahmia search 8.8.8.8"},
            {"type": "i2p", "query": "I2P search 8.8.8.8"},
        ],  # noqa: E501
    ...
    dspy.Example(
        ...
        max_queries=3,
        dark_queries=[
            {"type": "onion", "query": "ahmia 185.220.101.42"},
            {"type": "paste", "query": "pastebin 185.220.101.42"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ...
        max_queries=4,
        dark_queries=[
            {"type": "onion", "query": "ahmia 45.33.32.156 BGP"},
            {"type": "i2p", "query": "I2P 45.33.32.156"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    ...
    dspy.Example(
        ...
        max_queries=8,
        dark_queries=[
            {"type": "onion", "query": "ahmia search evil-domain.ru mirror"},
            {"type": "onion", "query": "to料的 evil-domain.ru"},
            {"type": "paste", "query": "pastebin evil-domain.ru C2"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ...
        max_queries=6,
        dark_queries=[
            {"type": "onion", "query": "ahmia moonlighting-market.ru"},
            {"type": "i2p", "query": "I2P moonlighting-market.ru"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ...
        max_queries=4,
        dark_queries=[
            {"type": "onion", "query": "ahmia protonmail3xxx.onion"},
            {"type": "i2p", "query": "I2P search protonmail"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ...
        max_queries=5,
        dark_queries=[
            {"type": "onion", "query": "ahmia example-login-portal.com phishing"},
            {"type": "paste", "query": "pastebin example-login-portal.com"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    ...
    dspy.Example(
        ...
        max_queries=6,
        dark_queries=[
            {"type": "ipfs", "query": "IPFS CID 4a5f8c3d hash"},
            {"type": "onion", "query": "ahmia 4a5f8c3d data leak"},
            {"type": "paste", "query": "pastebin 4a5f8c3d"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ...
        max_queries=4,
        dark_queries=[
            {"type": "ipfs", "query": "IPFS CID b19a md5 breach"},
            {"type": "paste", "query": "pastebin md5 b19a breach"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
    ...
    dspy.Example(
        ...
        max_queries=8,
        dark_queries=[
            {"type": "onion", "query": "ahmia CVE-2024-1701 exploit"},
            {"type": "onion", "query": "to料的 CVE-2024-1701"},
            {"type": "paste", "query": "pastebin CVE-2024-1701"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ...
        max_queries=6,
        dark_queries=[
            {"type": "onion", "query": "ahmia CVE-2023-44487"},
            {"type": "paste", "query": "pastebin CVE-2023-44487"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ...
        max_queries=10,
        dark_queries=[
            {"type": "onion", "query": "ahmia log4j shell"},
            {"type": "onion", "query": "to料的 log4j"},
            {"type": "paste", "query": "pastebin log4j RCE"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    # mixed IOC cluster
    dspy.Example(
        ...
        max_queries=7,
        dark_queries=[
            {"type": "onion", "query": "ahmia evil.ru 192.168.1.1"},
            {"type": "ipfs", "query": "IPFS abc123"},
            {"type": "paste", "query": "pastebin abc123 evil.ru"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ...
        max_queries=6,
        dark_queries=[
            {"type": "onion", "query": "ahmia leaksploit.xyz"},
            {"type": "paste", "query": "pastebin leaksploit.xyz"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    ...
    dspy.Example(
        ...
        max_queries=5,
        dark_queries=[
            {"type": "paste", "query": "pastebin victim@company.com breach"},
            {"type": "onion", "query": "ahmia victim@company.com"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ...
        max_queries=4,
        dark_queries=[
            {"type": "paste", "query": "pastebin admin@shellcorp.net"},
            {"type": "onion", "query": "ahmia shellcorp.net"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    ...
    dspy.Example(
        ...
        max_queries=6,
        dark_queries=[
            {"type": "onion", "query": "ahmia suspect-portal.ru phishing"},
            {"type": "paste", "query": "pastebin suspect-portal.ru"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    ...
    dspy.Example(
        ...
        max_queries=5,
        dark_queries=[
            {"type": "onion", "query": "ahmia bc1qxy2kgp ransomware"},
            {"type": "paste", "query": "pastebin bc1qxy2kgp"},
        ],  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
]
...
def main() -> None:
    ...
    parser.add_argument("program", choices=["dark_query", "hypothesis_generator"], help="Program to compile")
    parser.add_argument("--train", type=Path, default=None, help="Training data JSONL file (not needed with --builtin)")
    parser.add_argument("--builtin", action="store_true", help="Use built-in synthetic trainset (no --train needed)")
