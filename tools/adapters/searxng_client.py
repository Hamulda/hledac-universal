...
class _CircuitBreaker:
    ...
    def __init__(self, failure_threshold: int = 3, cooldown: int = 60) -> None:
...
class SearxngClient:
    ...
    __slots__ = ("_breaker", "_stealth", "base_url")

    def __init__(self, stealth, base_url: str = "http://localhost:8080") -> None:
        """
    ...
    async def search(
        self, query: str, max_results: int = 20, categories: list[str] | None = None
    ) -> list[dict[str, Any]]:
        """
