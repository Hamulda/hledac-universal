...
def _build_temporal_domain_hypotheses(
    domain_list: list[str], finding_map: dict[str, list[str]]
...
def _dspy_generate(
    findings: list[Any], current_seeds: list[str], sprint_depth: int, graph: DuckPGQGraph | None
) -> list[ResearchHypothesis]:
...
class HypothesisGenerator:
    ...
    def generate(
        self, findings: list[Any], current_seeds: list[str], sprint_depth: int = 1
    ) -> list[ResearchHypothesis]:
