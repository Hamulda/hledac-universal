...
class ParallelStageExecutor:
    ...
    def __init__(self, stage_configs: list[StageConfig], *, backpressure_maxsize: int = 256) -> None:
        ...
        self._running = False
        self._name_to_config: dict[str, StageConfig] = {c.name: c for c in stage_configs}
    ...
    def _get_stage_input(self, config: StageConfig, completed_results: dict[str, StageResult]) -> Any:
    ...
    async def _run_stage(self, config: StageConfig, input_batch: Any, parallel_group: str) -> StageResult:
