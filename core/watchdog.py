...
class Watchdog:
    ...
    """
    __slots__ = tuple(('_impl', '_running'))

    def __init__(self, threshold_mb: int | None=None, check_interval: float | None=None, callback: collections.abc.Callable[..., None] | None=None) -> None:
