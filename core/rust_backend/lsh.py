# lsh.py — LSH index domain for O(1) near-duplicate detection.
#
# ISSUE-008: Rust LSH index (lsh_index.rs) wired via DelegatingDomainMeta.
# Python fallback: _PythonLshIndex pure-Python OrderedDict bucketing.
...
# ---------------------------------------------------------------------------
# Rust domain (when Rust extension is available)
# ---------------------------------------------------------------------------
