...
Usage in a capability module:
    from hledac.universal.core.capability_cost import capability_cost, get_capability_cost
...
def capability_cost(
    *,
    ...
    Usage:
        from hledac.universal.core.capability_cost import capability_cost
