...
class StorageRouter:
    ...
    """
    __slots__ = tuple(('_backends', '_governor', '_invalidation_subscribers', '_state_lock', '_stats'))
    ...
    async def aput(self, key: str, value: Any, *, data_kind: str) -> bool:
        ...
        return await loop.run_in_executor(None, lambda: self.put(key, value, data_kind=data_kind))
    ...
    async def aget(self, key: str, *, data_kind: str) -> Any:
        ...
        """
        loop = asyncio.get_running_loop()
        return await loop.run_in_executor(None, lambda: self.get(key, data_kind=data_kind))
    ...
    async def adelete(self, key: str, *, data_kind: str) -> bool:
        ...
        """
        loop = asyncio.get_running_loop()
        return await loop.run_in_executor(None, lambda: self.delete(key, data_kind=data_kind))
