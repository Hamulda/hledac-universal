...
def _rule0g_prewindup_barrier(inp: NextActionInput) -> tuple[str, str | None] | None:
    ...
    if has_barrier_telemetry and inp.runtime_truth.get('cycles_started', 0) > 0 and inp.runtime_truth.get('primary_signal_source') and (not inp.prewindup_barrier_checked):
    ...
    if inp.prewindup_barrier_checked and inp.prewindup_barrier_satisfied and prewindup_required_lanes and (not any((lane in prewindup_attempted_lanes for lane in prewindup_required_lanes))) and (inp.ct_findings == 0) and (inp.public_findings == 0):
...
def _rule_profile_propagation(inp: NextActionInput) -> tuple[str, str | None] | None:
    ...
    if has_rg_telemetry and rg_checked is False and (inp.runtime_truth.get('cycles_started', 0) > 0) and inp.runtime_truth.get('primary_signal_source') and (inp.feed_findings > 0) and (inp.ct_findings == 0) and (inp.public_findings == 0):
...
def _derive_next_action(status: MeasurementStatus, is_memory_gate_abort: bool, nonfeed_accepted_findings: int, public_fetch_attempted: bool, public_findings: int, feed_findings: int, total_findings: int, ct_findings: int, runtime_truth: dict, feed_dominance_score: float | None=None, top_public_reject_reason: str | None=None, nonfeed_starvation_suspected: bool=False, prewindup_barrier_checked: bool=False, prewindup_barrier_satisfied: bool=False, prewindup_required_lanes: list[str] | None=None, prewindup_attempted_lanes: list[str] | None=None, acquisition_strategy: dict | None=None, return_guard_observation: dict | None=None, scheduler_exit: dict | None=None, acquisition_terminality_checked: bool | None=None, acquisition_terminality_satisfied: bool | None=None, acquisition_terminality_missing_lanes: list[str] | None=None, run_quality_verdict: str | None=None, acquisition_prelude_checked: bool | None=None, acquisition_prelude_ran: bool | None=None, acquisition_prelude_required_lanes: list[str] | None=None, acquisition_prelude_terminal_lanes: list[str] | None=None, acquisition_prelude_missing_lanes: list[str] | None=None, acquisition_prelude_skipped_lanes: dict | None=None, acquisition_prelude_errors: dict | None=None, acquisition_prelude_duration_s: float | None=None, acquisition_prelude_reason: str | None=None, windup_guard_observation: dict | None=None, scheduler_deadline_enforced: bool=False, scheduler_deadline_checks: int=0) -> tuple[str, str | None]:
    ...
    """
    inp = NextActionInput(status=status, is_memory_gate_abort=is_memory_gate_abort, nonfeed_accepted_findings=nonfeed_accepted_findings, public_fetch_attempted=public_fetch_attempted, public_findings=public_findings, feed_findings=feed_findings, total_findings=total_findings, ct_findings=ct_findings, runtime_truth=runtime_truth, feed_dominance_score=feed_dominance_score, top_public_reject_reason=top_public_reject_reason, nonfeed_starvation_suspected=nonfeed_starvation_suspected, prewindup_barrier_checked=prewindup_barrier_checked, prewindup_barrier_satisfied=prewindup_barrier_satisfied, prewindup_required_lanes=prewindup_required_lanes, prewindup_attempted_lanes=prewindup_attempted_lanes, acquisition_strategy=acquisition_strategy, return_guard_observation=return_guard_observation, scheduler_exit=scheduler_exit, acquisition_terminality_checked=acquisition_terminality_checked, acquisition_terminality_satisfied=acquisition_terminality_satisfied, acquisition_terminality_missing_lanes=acquisition_terminality_missing_lanes, run_quality_verdict=run_quality_verdict, acquisition_prelude_checked=acquisition_prelude_checked, acquisition_prelude_ran=acquisition_prelude_ran, acquisition_prelude_required_lanes=acquisition_prelude_required_lanes, acquisition_prelude_terminal_lanes=acquisition_prelude_terminal_lanes, acquisition_prelude_missing_lanes=acquisition_prelude_missing_lanes, acquisition_prelude_skipped_lanes=acquisition_prelude_skipped_lanes, acquisition_prelude_errors=acquisition_prelude_errors, acquisition_prelude_duration_s=acquisition_prelude_duration_s, acquisition_prelude_reason=acquisition_prelude_reason, windup_guard_observation=windup_guard_observation, scheduler_deadline_enforced=scheduler_deadline_enforced, scheduler_deadline_checks=scheduler_deadline_checks)
    for helper in [_rule_wallclock_enforcement, _rule0g_prewindup_barrier, _rule_profile_propagation, _rule_provider_surface, _rule_terminality, _rule_quality_gate, _rule0b_memory_or_swap_gate, _rule_default]:
        result = helper(inp)
