    ...
    def report(self) -> None:
        ...
        for result in self.results:
            ...
            if is_baseline and self.baseline:
                ...
                overhead_pct = (
                    ((result.mean_ms - self.baseline.mean_ms) / self.baseline.mean_ms * 100)
...
def run_benchmark(
    name: str, async_func: AsyncFunc, iterations: int = 1000, warmup: int = 100, detailed: bool = False
) -> BenchmarkResult:
    """
...
def benchmark_native_rust_future() -> BenchmarkResult | None:
    ...
    """
    try:
        from hledac.universal.rust_extensions.tracing import async_span_enter, async_span_exit, is_tracing_active
