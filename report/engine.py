# report/engine.py
# Issue 12.1: Unified ReportEngine
"""
...
class ReportEngine:
        ...
        for fmt in formats:
            try:
                if fmt == "json":
                    ...
                    results["md"] = self._render_md(
                        report_data, output_dir, sprint_id, template
                    )
                elif fmt == "html":
    ...
    def _render_json(
        self, data: dict[str, Any], output_dir: Path, sprint_id: str
    ) -> ReportOutput:
        """Render to JSON."""
    ...
    def _render_md(
        ...
        context = {
            ...
            "summary": data.get("summary", "_No summary_"),
