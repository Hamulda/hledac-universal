...
class FeatureFlag(Enum):
    ...
    # ISSUE #4: Dual-engine IOC graph dispatch
    # When 1: DuckPGQGraph (DuckDB-backed) is primary
    # When 0: IOCGraph (Kuzu Python-bound) is fallback
    IOC_GRAPH = "HLEDAC_ENABLE_IOC_GRAPH"
    ...
    COVER_TRAFFIC_MAX = "HLEDAC_COVER_TRAFFIC_MAX"
    BLITZ_FETCH = "HLEDAC_BLITZ_FETCH"
    RATE_LIMIT_RPS = "HLEDAC_RATE_LIMIT_RPS"
    TOKEN_BUCKET_RATE = "HLEDAC_TOKEN_BUCKET_RATE"
    TOKEN_BUCKET_CAPACITY = "HLEDAC_TOKEN_BUCKET_CAPACITY"
    ...
    # Discovery FTS tuning knobs (L1: read via _core.env_config.ENV)
    FTS_MAX_BATCH_SIZE = "HLEDAC_FTS_MAX_BATCH_SIZE"
    FTS_WAL_MAX_MB = "HLEDAC_FTS_WAL_MAX_MB"
    FTS_RRF_K = "HLEDAC_FTS_RRF_K"
    ...
    DUCKDB_HARD_MEMORY = "HLEDAC_DUCKDB_HARD_MEMORY"
    DUCKDB_ARROW_QUEUE_MAXSIZE = "HLEDAC_DUCKDB_ARROW_QUEUE_MAXSIZE"
    DUCKDB_ARROW_QUEUE_TIMEOUT_S = "HLEDAC_DUCKDB_ARROW_QUEUE_TIMEOUT_S"
...
def _build_metadata() -> dict[FeatureFlag, dict]:
    ...
    category_map: dict[str, FlagCategory] = {
        ...
        "HLEDAC_COVER_TRAFFIC_MAX": FlagCategory.STEALTH,
        "HLEDAC_BLITZ_FETCH": FlagCategory.SYSTEM,
        "HLEDAC_RATE_LIMIT_RPS": FlagCategory.SYSTEM,
        "HLEDAC_TOKEN_BUCKET_RATE": FlagCategory.NETWORK,
        "HLEDAC_TOKEN_BUCKET_CAPACITY": FlagCategory.NETWORK,
        ...
        "HLEDAC_DUCKDB_HARD_MEMORY": FlagCategory.STORAGE,
        "HLEDAC_DUCKDB_ARROW_QUEUE_MAXSIZE": FlagCategory.STORAGE,
        "HLEDAC_DUCKDB_ARROW_QUEUE_TIMEOUT_S": FlagCategory.STORAGE,
        ...
        # Discovery FTS tuning knobs (L1)
        "HLEDAC_FTS_MAX_BATCH_SIZE": FlagCategory.STORAGE,
        "HLEDAC_FTS_WAL_MAX_MB": FlagCategory.STORAGE,
        "HLEDAC_FTS_RRF_K": FlagCategory.STORAGE,
        # Network / Transport
