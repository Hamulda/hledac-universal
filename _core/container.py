...
usage:
    from hledac.universal._core.container import ServiceContainer, get_global_container
...
def _seed_global_container(container: ServiceContainer) -> None:
    ...
    try:
        import hledac.universal._core.capabilities as cap_module
            ...
            if not isinstance(cap_obj, type) and hasattr(cap_obj, "name") and hasattr(cap_obj, "import_path"):
                try:
                    ...
                    def _factory(c: Any = cap_obj) -> Any:
                        from hledac.universal._core.capabilities import CAPS as _caps
