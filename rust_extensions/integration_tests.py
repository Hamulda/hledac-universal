...
TESTABLE_MODULES = {
    "bloom": {
        "feature": "core",
        "tests": ["test_bloom_filter_basic", "test_bloom_filter_false_positive_rate", "test_url_set_basic"],
    },
    "hash": {"feature": "core", "tests": ["test_content_hash_hex", "test_sha256_hex", "test_batch_hash"]},
    "memory": {"feature": "core", "tests": ["test_get_process_rss", "test_memory_pressure", "test_available_memory"]},
    "simd": {"feature": "core", "tests": ["test_neon_detection", "test_dot_product"]},
    "rate_limit": {"feature": "core", "tests": ["test_token_bucket_basic"]},
    "aho_corasick": {"feature": "core", "tests": ["test_aho_basic", "test_aho_multi_pattern"]},
    "sprint_policies": {"feature": "core", "tests": ["test_lane_budget_pool"]},
    "spsc_queue": {"feature": "core", "tests": ["test_spsc_basic"]},
    "dns": {"feature": "dns", "tests": ["test_dns_resolve_sync"], "requires_network": True},
    "tls": {"feature": "tls13", "tests": ["test_tls_metadata_extract"], "requires_network": True},
    "anti_analysis": {
        "feature": "anti_analysis",
        "tests": ["test_anti_analysis_domain_check"],
        "requires_network": True,
    },
    "graph": {"feature": "data", "tests": ["test_graph_centrality", "test_link_prediction"]},
    "mlx_bridge": {"feature": "mlx_fabric", "tests": ["test_mlx_alloc_basic"], "platform": "macos"},
    "iosurface_bridge": {"feature": "iosurface", "tests": ["test_iosurface_descriptor"], "platform": "macos"},
    "ane": {"feature": "ane", "tests": ["test_ane_availability"], "platform": "macos"},
    "whisper": {"feature": "whisper", "tests": ["test_whisper_availability"]},
    "stix_2_1": {"feature": "stix", "tests": ["test_stix_encode_decode"]},
    "feed_pipeline": {"feature": "advanced", "tests": ["test_feed_entry_pipeline"]},
}
...
@pytest.fixture
def skip_if_rust_unavailable(rust_available: bool) -> None:
...
@pytest.fixture
def skip_if_network_unavailable() -> None:
...
class TestBloomFilter:
    ...
    def test_bloom_filter_false_positive_rate(self, rust_backend, skip_if_rust_unavailable) -> None:
    ...
    def test_url_set_basic(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestHash:
    ...
    def test_content_hash_hex(self, rust_backend, skip_if_rust_unavailable) -> None:
    ...
    def test_sha256_hex(self, rust_backend, skip_if_rust_unavailable) -> None:
    ...
    def test_batch_hash(self, rust_backend, skip_if_rust_unavailable) -> None:
        """Test batch hashing."""
...
class TestMemory:
    ...
    def test_get_process_rss(self, rust_backend, skip_if_rust_unavailable) -> None:
    ...
    def test_memory_pressure(self, rust_backend, skip_if_rust_unavailable) -> None:
    ...
    def test_available_memory(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestSIMD:
    ...
    def test_neon_detection(self, rust_backend, skip_if_rust_unavailable) -> None:
    ...
    def test_dot_product(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestRateLimit:
    ...
    def test_token_bucket_basic(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestAhoCorasick:
    ...
    def test_aho_basic(self, rust_backend, skip_if_rust_unavailable) -> None:
    ...
    def test_aho_multi_pattern(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestSprintPolicies:
    ...
    def test_lane_budget_pool(self, rust_backend, skip_if_rust_unavailable) -> None:
        """Test LaneBudgetPool."""
...
class TestSPSCQueue:
    ...
    def test_spsc_basic(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestDNS:
    ...
    def test_dns_resolve_sync(self, rust_backend, skip_if_rust_unavailable, skip_if_network_unavailable) -> None:
...
class TestTLS:
    ...
    def test_tls_metadata_extract(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestAntiAnalysis:
    ...
    def test_anti_analysis_domain_check(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestGraph:
    ...
    def test_graph_centrality(self, rust_backend, skip_if_rust_unavailable) -> None:
    ...
    def test_link_prediction(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestMLXBridge:
    ...
    def test_mlx_alloc_basic(self, rust_backend, skip_if_rust_unavailable, skip_if_not_macos) -> None:
...
class TestIOSurfaceBridge:
    ...
    def test_iosurface_descriptor(self, rust_backend, skip_if_rust_unavailable, skip_if_not_macos) -> None:
...
class TestANE:
    ...
    def test_ane_availability(self, rust_backend, skip_if_rust_unavailable, skip_if_not_macos) -> None:
...
class TestWhisper:
    ...
    def test_whisper_availability(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestSTIX:
    ...
    def test_stix_encode_decode(self, rust_backend, skip_if_rust_unavailable) -> None:
...
class TestFeedPipeline:
    ...
    def test_feed_entry_pipeline(self, rust_backend, skip_if_rust_unavailable) -> None:
    ...
    if args.json:
        ...
        data = {
            module_name: {
                ...
                "error": r.error,
                "results": [
                    {"name": tr.name, "passed": tr.passed, "duration_ms": tr.duration_ms, "error": tr.error}
                    for tr in r.results
                ],
            }
            for module_name, r in results.items()
        }
