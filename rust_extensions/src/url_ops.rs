...
fn matches_any_word(haystack: &str, needle: &str) -> bool {
    ...
    let bytes = haystack.as_str();
    let nlen = needle.as_str();
    let mut start = 0;
