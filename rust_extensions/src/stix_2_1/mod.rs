...
pub fn register_functions(m: &Bound<'_, PyModule>) -> PyResult<()> {
    m.add_function(wrap_pyfunction!(stix_2_1::encode_finding, m)?)?;
    m.add_function(wrap_pyfunction!(stix_2_1::encode_findings_batch, m)?)?;
    m.add_function(wrap_pyfunction!(stix_2_1::encode_finding_pretty, m)?)?;
    m.add_function(wrap_pyfunction!(stix_2_1::decode_bundle, m)?)?;
    m.add_function(wrap_pyfunction!(stix_2_1::validate_json, m)?)?;
    Ok(())
}
