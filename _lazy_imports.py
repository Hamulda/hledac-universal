...
def get_M1ResourceGovernor() -> type:
    ...
    """
    return _lazy_import_class(
        "hledac.universal.runtime.resource_governor",
        "M1ResourceGovernor",
    )
...
def get_all_service_status() -> dict[str, LazyServiceInfo]:
    ...
    """
    services = [
        ("DuckDBShadowStore", "hledac.universal.knowledge.duckdb_store", "DuckDBShadowStore"),
        ("M1ResourceGovernor", "hledac.universal.runtime.resource_governor", "M1ResourceGovernor"),
        ("Hermes3Engine", "hledac.universal.brain.hermes3_engine", "Hermes3Engine"),
        ("EvidenceLog", "hledac.universal.evidence_log", "EvidenceLog"),
        ("SidecarOrchestrator", "hledac.universal.runtime.sidecar_orchestrator", "SidecarOrchestrator"),
    ]
