...
class TestAcquisitionFallback:
    ...
    def test_fallback_used_when_build_raises(self) -> None:
    ...
    def test_fallback_uses_nd_profile_when_available(self) -> None:
    ...
    def test_build_acquisition_report_fallback_used_field(self) -> None:
    ...
    def test_build_acquisition_report_nonfeed_diagnostic(self) -> None:
    ...
    def test_fallback_report_contains_all_f214_fields(self) -> None:
...
class TestEnvVarOverrideLogging:
    ...
    def test_env_var_does_not_log_when_default(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_env_var_logs_when_actually_overriding(self, monkeypatch: pytest.MonkeyPatch) -> None:
