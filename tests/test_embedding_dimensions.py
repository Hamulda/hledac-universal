...
class TestEmbeddingDimensions:
    ...
    def test_mlx_embedding_dim_returns_256(self) -> None:
        ...
        from _core.mlx_embeddings import MLXEmbeddingManager

        assert hasattr(MLXEmbeddingManager, "EMBEDDING_DIM"), "MLXEmbeddingManager missing EMBEDDING_DIM attribute"
    ...
    def test_mlx_mrl_dim_equals_embedding_dim(self) -> None:
        ...
        assert hasattr(MLXEmbeddingManager, "MRL_DIM"), "MLXEmbeddingManager missing MRL_DIM attribute"
    ...
    def test_lancedb_store_mrl_dim_is_256(self) -> None:
        ...
        assert "_current_mrl_dim = 256" in source, "LanceDBIdentityStore.__init__ must set _current_mrl_dim = 256"
    ...
    def test_embedding_pipeline_mrl_dim_is_256(self) -> None:
        ...
        assert hasattr(embedding_pipeline, "_EMBEDDING_DIM"), "embedding_pipeline missing _EMBEDDING_DIM attribute"
    ...
    def test_all_backends_consistent(self) -> None:
        ...
        mismatches = [f"{name}={dim}" for name, dim in dimensions.items() if dim != CANONICAL_DIM]
...
class TestMRLArchitecture:
    ...
    def test_native_dim_is_modernbert_768(self) -> None:
        ...
        assert hasattr(MLXEmbeddingManager, "NATIVE_DIM"), "MLXEmbeddingManager missing NATIVE_DIM attribute"
    ...
    def test_mrl_dims_is_canonical_tuple(self) -> None:
        ...
        assert hasattr(MLXEmbeddingManager, "MRL_DIMS"), "MLXEmbeddingManager missing MRL_DIMS attribute"
        ...
        assert isinstance(MLXEmbeddingManager.MRL_DIMS, tuple), "MRL_DIMS must be a tuple for immutability"
    ...
    def test_mrl_canonical_in_canonical_dims(self) -> None:
        ...
        assert MLXEmbeddingManager.EMBEDDING_DIM in MLXEmbeddingManager.MRL_DIMS, (
            f"EMBEDDING_DIM={MLXEmbeddingManager.EMBEDDING_DIM} must be in MRL_DIMS={MLXEmbeddingManager.MRL_DIMS}"
        )
    ...
    def test_assert_embedding_dimension_supports_512(self) -> None:
        ...
        from _core.mlx_embeddings import assert_embedding_dimension
        ...
        assert "512" in src, "assert_embedding_dimension() must validate 512 as a valid dim"
