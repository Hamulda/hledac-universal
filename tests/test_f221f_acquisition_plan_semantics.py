...
class TestF221F_PlanSemanticsSplit:  # noqa: N801
    ...
    def test_empty_prelude_plan_but_public_required_creates_effective_plan(self) -> None:
        """
    ...
    def test_runtime_attempted_lanes_extracted_from_source_family_outcomes(self) -> None:
        """
    ...
    def test_plan_semantics_effective_runtime_when_lanes_attempted(self) -> None:
        """
    ...
    def test_plan_semantics_prelude_only_when_no_lanes_attempted(self) -> None:
        """
    ...
    def test_domain_prelude_plan_still_preserved(self) -> None:
        """
        ...
        plan_snapshot = AcquisitionStrategySnapshot(
            plans=[
                AcquisitionLanePlan(
    ...
    def test_no_runtime_behavior_changes_report_only(self) -> None:
        """
    ...
    def test_effective_acquisition_plan_union(self) -> None:
        """
    ...
    def test_required_lane_plan_from_terminality(self) -> None:
        """
    ...
    def test_empty_source_family_outcomes_prelude_only(self) -> None:
        """
...
class TestFix5_AcquisitionPlanCache:
    ...
    def test_different_query_produces_different_key(self) -> None:
    ...
    def test_feed_domain_seeds_order_independent(self) -> None:
    ...
    def test_get_cached_plan_moves_to_end(self) -> None:
    ...
    def test_get_cached_plan_returns_none_on_miss(self) -> None:
        """_get_cached_plan returns None when key not in cache."""
        _acquisition_plan_cache.clear()
        result = _get_cached_plan("nonexistent")
        assert result is None

    def test_cache_key_with_feed_domain_seeds(self) -> None:
    ...
    def test_cache_key_with_synthetic_domains(self) -> None:
        ...
        key_with_syn = _build_plan_cache_key(
            ...
            acquisition_profile="default",
            feed_domain_seeds=(),
            synthetic_domains=("synthetic.ai",),
        )
        assert key_no_syn != key_with_syn

    def test_different_aggressive_mode_produces_different_key(self) -> None:
