...
class TestMemoryLayerUsesCanonicalEngine:
    ...
    @pytest.mark.asyncio
    async def test_memory_layer_uses_canonical_engine(self):
        """
    ...
    @pytest.mark.asyncio
    async def test_memory_layer_load_model_without_engine(self):
        """
    ...
    @pytest.mark.asyncio
    async def test_memory_layer_model_property_is_shared(self):
        """
    ...
    @pytest.mark.asyncio
    async def test_mlx_load_not_called_for_hermes(self):
        """
    ...
    @pytest.mark.asyncio
    async def test_non_hermes_model_still_returns_none(self):
        """
    ...
    @pytest.mark.asyncio
    async def test_engine_not_loaded_triggers_ensure_model_loaded(self):
        """
    ...
    @pytest.mark.asyncio
    async def test_mount_lazy_resolves_engine_from_context(self):
        """
        ...
        mock_ctx = MagicMock()
        mock_ctx.get = MagicMock(side_effect=lambda key: mock_engine if key in ('deephermes3_engine', 'hermes_engine') else None)
