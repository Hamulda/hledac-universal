...
class TestPromptInjectionSanitizationPropertyBased:
    ...
    def test_never_crashes_on_any_input(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=50, deadline=None)
    def test_deterministic_output(self, text_content) -> None:
    ...
    def test_truncation_at_max_chars(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_safe_text_not_longer_than_input(self, text_content) -> None:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_final_chars_reflects_actual_safe_text(self, text_content) -> None:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_non_string_returns_non_suspicious(self, non_str) -> None:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_empty_string_returns_clean(self, text_content) -> None:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_max_chars_zero_returns_empty(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=5000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_result_has_required_fields(self, text_content) -> None:
    ...
    def test_layers_passed_minimum_1(self, text_content) -> None:
...
class TestInstructionOverrideDetection:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_instruction_override_detected_across_separators(self, phrase, separator) -> None:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_malicious_phrase_detected_with_context(self, phrase, prefix, suffix) -> None:
    ...
    @given(
        safe_text=text(
            ...
            max_size=2000,
            alphabet=characters(
                whitelist_categories=["L", "N", "Z", "Zs"], whitelist_characters=[" ", ".", ",", "!", "?"]
            ),
        )
    )
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_clean_text_may_produce_no_detection(self, safe_text) -> None:
...
class TestUnicodeNormalizationPropertyBased:
    ...
    @given(text_content=text(min_size=0, max_size=5000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_normalize_never_increases_length(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=5000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_normalize_never_returns_none(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=5000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_normalize_deterministic(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=5000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_replacements_count_matches_actual(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=5000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_nfc_normalization_applied(self, text_content) -> None:
...
class TestStructuralInjectionDetection:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_detect_structural_never_crashes(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=10_000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_detect_structural_deterministic(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=5000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_html_comment_injection_detected(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=5000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_zero_width_flood_detected(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=5000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_clean_text_may_produce_empty_detection(self, _text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=10_000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_repeated_delimiter_lines_detected(self, text_content) -> None:
...
class TestPromptInjectionValidatorPropertyBased:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_validator_never_crashes(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_validator_deterministic(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_validator_internal_error_fallback(self, text_content) -> None:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_validator_handles_extreme_length(self, short_text, long_text) -> None:
...
class TestPromptSanitizationEdgeCases:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_binary_input_handled(self, binary_content) -> None:
    ...
    @given(
        high_unicode=text(
            min_size=0,
            max_size=2000,
            alphabet=characters(whitelist_categories=["So", "Sm", "Sc", "Pd", "Pe", "Pc", "Po"]),
        )
    )
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_symbol_heavy_text_handled(self, high_unicode) -> None:
        """Text composed mainly of symbol characters doesn't crash."""
        result = sanitize_prompt_injection_patterns(high_unicode)
        assert isinstance(result, PromptInjectionValidationResult)

    @given(
        long_repetition=tuples(
            text(min_size=1, max_size=10),
            integers(min_value=1000, max_value=5000),
        )
    )
    @settings(verbosity=Verbosity.verbose, max_examples=10, deadline=None)
    def test_highly_repetitive_text_handled(self, long_repetition) -> None:
    ...
    @settings(verbosity=Verbosity.verbose, max_examples=10, deadline=None)
    def test_mixed_list_input_handled(self, mixed_content) -> None:
        """Mixed list of text/binary chunks handled."""
        text_block = b"--separator--".join(c if isinstance(c, bytes) else c.encode() for c in mixed_content)
        try:
...
class TestPromptInjectionBoundaryInvariants:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_suspicious_flag_matches_patterns(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_original_chars_equals_input_len(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_reason_always_non_empty(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_normalization_applied_is_boolean(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_homoglyph_replacements_non_negative(self, text_content) -> None:
    ...
    @given(text_content=text(min_size=0, max_size=200_000))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_rust_aho_used_is_boolean(self, text_content) -> None:
...
class TestHomoglyphReplacementPreservesSemantics:
    ...
    @given(
        clean_text=text(
            min_size=0, max_size=5000, alphabet=characters(whitelist_categories=["L", "N", "Zs", "Punctuation"])
        )
    )
    @settings(verbosity=Verbosity.verbose, max_examples=30, deadline=None)
    def test_clean_ascii_unchanged(self, clean_text) -> None:
    ...
    @given(cyrillic_text=text(min_size=0, max_size=5000, alphabet=characters(whitelist_categories=["Cyrillic"])))
    @settings(verbosity=Verbosity.verbose, max_examples=20, deadline=None)
    def test_cyrillic_replaced(self, cyrillic_text) -> None:
