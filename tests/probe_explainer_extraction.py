...
successfully extracted from :mod:`brain.hypothesis_engine_engine` into
:mod:`brain.hypothesis_engine.explainer`, with byte-for-byte class equivalence
...
class TestBackwardCompat:
    ...
    def test_legacy_class_is_same_object(self) -> None:
        ...
        from brain.hypothesis_engine.explainer import SimpleNodeAblationExplainer as New
        ...
        assert New.__module__ == "brain.hypothesis_engine.explainer"


# ── Forward import path: brain.hypothesis_engine.explainer ───────────────────────


class TestForwardImport:
    def test_package_exports_explainer(self) -> None:
        """`from brain.hypothesis_engine import SimpleNodeAblationExplainer` must work."""
