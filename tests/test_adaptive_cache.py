...
class TestCacheStats:
    ...
    def test_hit_ratio_with_hits(self) -> None:
...
class TestAdaptiveCacheInit:
    ...
    def test_pressure_property(self) -> None:
        cache = AdaptiveCache()
...
class TestAdaptiveCacheRustIntegration:
    ...
    def test_init_without_rust(self) -> None:
    ...
    def test_put_get_without_rust(self) -> None:
...
class TestAdaptiveCacheMemoryPressure:
    ...
    def test_memory_check_throttling(self) -> None:
    ...
    def test_update_limits_elevated(self) -> None:
    ...
    def test_update_limits_critical(self) -> None:
...
class TestAdaptiveCacheRegistry:
    ...
    def test_get_cache_not_found(self) -> None:
...
class TestAdaptiveCacheFactory:
    ...
    def test_create_adaptive_cache(self) -> None:
...
class TestAdaptiveCacheM1Bounds:
    ...
    def test_m1_8gb_safe(self) -> None:
