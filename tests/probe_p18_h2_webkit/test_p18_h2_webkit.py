...
class TestH2SafariPresetRustExtension:
    ...
    def test_safari18_settings_known_values(self):
    ...
    def test_webkit_window_increment(self):
    ...
    def test_needs_webkit_preset_non_safari(self):
    ...
    def test_get_preset_for_profile(self):
    ...
    def test_validate_safari_fingerprint(self):
...
class TestCurlCffiFetchWebKitIntegration:
    ...
    def test_webkit_h2_profiles_constant(self):
    ...
    def test_is_webkit_h2_profile(self):
    ...
    def test_webkit_window_increment_constant(self):
    ...
    def test_h2_webkit_preset_flag_exists(self):
    ...
    def test_get_webkit_h2_settings_returns_dict(self):
    ...
    def test_get_webkit_h2_settings_non_safari(self):
...
class TestPublicFetcherTelemetry:
    ...
    def test_webkit_transport_stats_function_exists(self):
    ...
    def test_reset_webkit_transport_telemetry(self):
...
class TestH2SettingsFingerprint:
    ...
    def test_safari_max_concurrent_streams(self):
...
class TestWebKitProfilesList:
    ...
    def test_get_webkit_profiles(self):
