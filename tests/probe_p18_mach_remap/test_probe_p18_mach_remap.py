...
class TestFeatureGate:
    ...
    def test_min_size_default(self, monkeypatch):
    ...
    def test_min_size_override(self, monkeypatch):
...
class TestLazyImport:
    ...
    def test_get_mach_module_returns_none_when_disabled(self, monkeypatch):
    ...
    def test_no_module_loaded_at_import(self, monkeypatch):
...
class TestCanRemapGuards:
    ...
    def test_guard_platform(self, temp_file_large, monkeypatch):
    ...
    def test_guard_size_small(self, temp_file_small, monkeypatch):
    ...
    def test_guard_size_large(self, temp_file_large, monkeypatch):
...
class TestRemapForSandboxFailSoft:
    ...
    def test_returns_none_on_disabled(self, temp_file_large, monkeypatch):
    ...
    def test_returns_none_on_stat_error(self, monkeypatch):
    ...
    def test_returns_none_on_mach_remap_error(self, temp_file_large, monkeypatch):
    ...
    def test_returns_none_on_unexpected_exception(
        self, temp_file_large, monkeypatch
    ):
    ...
    def test_returns_machremapresult_on_success(
        self, temp_file_large, monkeypatch
    ):
...
class TestTempfileFallback:
    ...
    def test_create_tempfile_basic(self, temp_file_large):
    ...
    def test_create_tempfile_named(self, temp_file_small):
...
class TestStats:
    ...
    def test_stats_when_disabled(self, monkeypatch):
    ...
    def test_stats_when_module_available(self, monkeypatch):
...
class TestMediaSandboxIntegration:
    ...
    def test_sandbox_mach_remap_min_size_default(self, monkeypatch):
    ...
    def test_sandbox_mach_remap_min_size_override(self, monkeypatch):
    ...
    def test_get_mach_remap_bridge_returns_none_when_disabled(self, monkeypatch):
...
class TestDocumentIntelligenceIntegration:
    ...
    def test_class_var_mach_remap_min_size_default(self, monkeypatch):
    ...
    def test_class_var_mach_remap_min_size_override(self, monkeypatch):
...
class TestZeroCopySemantics:
    ...
    def test_remap_result_has_required_fields(self, monkeypatch):
    ...
    def test_can_remap_probe_guarantees_memory(self, monkeypatch):
    ...
    def test_large_file_above_threshold(self, temp_file_large):
...
class TestAsyncWrapper:
    ...
    @pytest.mark.asyncio
    async def test_remap_file_async_returns_none_when_disabled(self, temp_file_large, monkeypatch):
...
class TestRunWithZeroCopySandbox:
    ...
    @pytest.mark.asyncio
    async def test_fallback_to_tempfile(self, temp_file_small, monkeypatch):
