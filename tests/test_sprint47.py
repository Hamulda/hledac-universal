...
class TestSprint47(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_stegdetect_pool_semaphore(self) -> None:
    ...
    async def test_stegdetect_concurrent(self) -> None:
    ...
    async def test_sherlock_json_flag(self) -> None:
    ...
    async def test_sherlock_json_parse(self) -> None:
        ...
        with patch("asyncio.create_subprocess_exec", new_callable=AsyncMock) as mock_exec:
            ...
            mock_proc.communicate = AsyncMock(
                return_value=(
                    b'{"twitter": {"url": "https://twitter.com/testuser"}, "github": {"url": "https://github.com/testuser"}}',
                    b"",
                )
            )
            mock_exec.return_value = mock_proc
    ...
    async def test_batch_priority_tiebreaker(self) -> None:
    ...
    async def test_batch_priority_ordering(self) -> None:
    ...
    async def test_batch_adaptive(self) -> None:
    ...
    async def test_prefix_cache_hit(self) -> None:
    ...
    async def test_prefix_cache_lru(self) -> None:
        """LRU eviction should work when cache is full."""
        cache = OrderedDict()
        max_size = 3

        def cache_set(target_cache, key, value) -> None:
    ...
    def test_communication_layer_imports(self) -> None:
