...
@pytest.mark.asyncio
async def test_vision_encoder_dummy_mode(mock_governor) -> None:
...
def test_mamba_fusion_forward() -> None:
...
class TestF21PhashFallback:
    ...
    def test_phash_shape_1024(self) -> None:
    ...
    def test_phash_deterministic(self) -> None:
    ...
    def test_phash_in_unit_range(self) -> None:
    ...
    def test_phash_dissimilar_images_have_higher_hamming(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_encode_batch_fallback_uses_phash(self, mock_governor) -> None:
    ...
    def test_phash_corrupt_input_fails_soft(self) -> None:
