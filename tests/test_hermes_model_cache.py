...
class TestHermesModelCacheBasic:
    ...
    def test_put_get_returns_same(self):
    ...
    def test_duplicate_put_no_evict(self):
...
class TestHermesModelCacheLoRA:
    ...
    def test_lora_eviction_at_capacity(self):
...
class TestHermesModelCacheThreading:
    ...
    def test_concurrent_put_no_crash(self):
...
class TestHermesModelCacheSingleton:
    ...
    def test_hermes_cache_returns_same_instance(self):
        """hermes_cache() returns the module-level singleton."""
        c1 = hermes_cache()
        c2 = hermes_cache()
        assert c1 is c2

    def test_singleton_shared_across_threads(self):
...
class TestMaybeEvictBackwardCompat:
    ...
    def test_maybe_evict_import(self):
...
class TestMlxcCacheClear:
    ...
    def test_mlx_clear_no_mlx(self):
...
class TestStats:
    ...
    def test_lora_eviction_counter_increments(self):
