...
class TestGPUArbiterUnit:
    ...
    def test_arbiter_singleton(self) -> None:
    ...
    def test_should_defer_idle(self) -> None:
    ...
    def test_should_defer_pressure(self) -> None:
    ...
    def test_should_defer_boundary_idle(self) -> None:
    ...
    def test_should_defer_boundary_pressure(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_wait_until_free_returns_true_when_idle(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_wait_until_free_returns_false_on_timeout(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_wait_until_free_polls_until_recovered(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_wait_until_free_zero_timeout_no_wait(self) -> None:
...
class TestGPUArbiterEncodeAsyncIntegration:
    ...
    @pytest.mark.asyncio
    async def test_encode_async_checks_arbiter(self) -> None:
        """encode_async calls get_gpu_arbiter().should_defer() before encoding."""
        deferred = []

        def tracking_should_defer(_self) -> bool:
...
class TestProbeGpuFractionFailSafe:
    ...
    def test_should_defer_catches_exceptions(self) -> None:
