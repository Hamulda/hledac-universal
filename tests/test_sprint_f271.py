...
class TestF271CWindupLead:
    ...
    @pytest.mark.parametrize(
        ...
        [(60, 30.0, 30.0), (90, 30.0, 60.0), (180, 54.0, 126.0), (1800, 180.0, 1620.0)],
    )
...
class TestF271FEagerStartUloop:
    ...
    def test_export_dir_forwarded_by_root_dispatcher(self) -> None:
        ...
        assert "export_dir=" in src, (
            "F271F: root __main__.py dispatcher must forward export_dir to core run_sprint (regression: was dropped silently)"
        )
