...
class TestModelSwapCacheInvalidation:
    ...
    def test_invalidate_all_prompt_caches_clears_all(self):
    ...
    def test_telemetry_counter_added_to_init(self):
    ...
    @pytest.mark.asyncio
    async def test_load_model_cache_hit_invalidates_all(self):
...
class TestModelLifecycleCacheInvalidation:
    ...
    def test_load_model_triggers_invalidation_on_engine(self):
        ...
        assert 'model_lifecycle_swap' in call_args[0][0], \
            "Invalidation reason should contain 'model_lifecycle_swap'"
