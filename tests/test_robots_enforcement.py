...
class TestRobotsParserDefaults:
    ...
    def test_cache_ttl_900_seconds(self) -> None:
        """robots_parser cache_ttl=900 (15 min)."""
        from hledac.universal.utils.robots_parser import _DEFAULT_TTL_SECONDS

        assert _DEFAULT_TTL_SECONDS == 900, f"Expected TTL=900, got {_DEFAULT_TTL_SECONDS}"

    def test_max_cache_size_1024(self) -> None:
        ...
        from hledac.universal.utils.robots_parser import _MAX_CACHE_SIZE, RobotsParser
    ...
    def test_default_ua_is_chrome(self) -> None:
    ...
    def test_robots_parser_default_ua_is_chrome(self) -> None:
...
class TestRobotsParserCanFetch:
    ...
    def test_can_fetch_no_doc_returns_true(self) -> None:
    ...
    def test_can_fetch_specific_rule_blocks(self) -> None:
...
class TestRobotsCheckMethod:
    ...
    def test_robots_check_returns_tuple(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_robots_check_none_parser_allows(self) -> None:
...
class TestEffectiveUASetup:
    ...
    def test_effective_ua_slot_exists(self) -> None:
    ...
    def test_robots_parser_slot_exists(self) -> None:
...
class TestRobotsEnforcementIntegration:
    ...
    def test_robots_filter_in_do_step(self) -> None:
    ...
    def test_robots_check_method_exists(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_robots_check_crawl_delay_triggers_sleep(self) -> None:
...
class TestRobotsParserLifecycle:
    ...
    def test_do_initialize_robots_parser(self) -> None:
    ...
    def test_do_shutdown_robots_cleanup(self) -> None:
...
class TestFetchCoordinatorImports:
    ...
    def test_robots_parser_imported_in_do_initialize(self) -> None:
...
class TestCanonicalUAPool:
    ...
    def test_browser_ua_pool_chrome_present(self) -> None:
    ...
    def test_default_ua_matches_pool_format(self) -> None:
