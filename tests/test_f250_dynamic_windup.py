...
class TestF278ADynamicWindup(unittest.TestCase):
    ...
    def test_300s_sprint_windup_90s_active_210s(self) -> None:
    ...
    def test_300s_sprint_active_budget_meets_minimum(self) -> None:
    ...
    def test_600s_sprint_windup_at_ceiling(self) -> None:
    ...
    def test_60s_sprint_active_budget_30s(self) -> None:
    ...
    def test_120s_sprint_windup_36s(self) -> None:
    ...
    def test_1800s_sprint_capped_at_180s(self) -> None:
    ...
    def test_windup_lead_property_returns_float(self) -> None:
        """effective_windup_lead_s returns float for arithmetic compatibility."""
        cfg = SprintSchedulerConfig(sprint_duration_s=300)
        result = cfg.effective_windup_lead_s
        self.assertIsInstance(result, (int, float))

    def test_original_windup_lead_s_default_unchanged(self) -> None:
    ...
    def test_900s_sprint_windup_at_ceiling(self) -> None:
    ...
    def test_f278a_floor_at_30s_never_below(self) -> None:
    ...
    def test_f278a_ceiling_at_180s_never_above(self) -> None:
