...
class TargetMemoryService:
    ...
    def _enforce_facet_bound(self, facets: Mapping[str, Any], max_size: int, facet_type: str) -> dict[str, Any]:
    ...
    def _compute_facet_delta(self, existing: dict[str, Any], update: dict[str, Any], max_keys: int) -> dict[str, Any]:
        """
