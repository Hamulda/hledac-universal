...
_CLASSIFICATION_KEYWORDS = (r"\b(classify|categorize|osint|threat|indicator|type\s+of|what\s+kind)\b",)

# Relevance keywords
_RELEVANCE_KEYWORDS = (r"\b(relevant|irrelevant|skip|ignore|filter|priorit.y|important)\b",)

# Synthesis keywords
_SYNTHESIS_KEYWORDS = (r"\b(write|summarize|explain|describe|generate|create|compose)\b",)
...
def get_preferred_model(task_type: TaskType) -> str | None:
    """
...
def route_content(text: str) -> tuple[str | None, TaskType]:
    """
