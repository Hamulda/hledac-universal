...
if _MLX_NN_AVAILABLE:
    ...
    class CriticMLP(nn.Module):
        ...
        __slots__ = ("hidden_dims", "input_dim", "layers")
    ...
    class CriticMLP(_CriticMLPBase):
        ...
        __slots__ = ("hidden_dims", "input_dim")
...
class DistillationEngine:
    ...
    MAX_CHAIN_LENGTH = 50
    __slots__ = ("_critic", "_db_path", "_initialized", "embedding_dim", "embedding_model")
    ...
    async def train(self, n_epochs: int = 10) -> dict[str, float | int | str]:
        ...
        try:
            ...
            embedding_tasks = [
                loop.run_in_executor(executor, self._get_chain_embedding, example.chain) for example in examples
            ]
...
async def create_distillation_engine(
    embedding_model: Any | None = None, db_path: str | Path | None = None, embedding_dim: int = 384
