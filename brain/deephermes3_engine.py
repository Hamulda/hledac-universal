...
Do not include any other text. Output valid JSON only."""
    ...
    async def unload(self) -> None:
        ...
        # ISSUE-9 FIX: Reset prewarm flag after unload so next sprint cycle is clean.
        # Without this, _mlx_prewarm_active stays True forever after first warm sprint,
        # causing subsequent unloads to incorrectly skip Metal cache clear.
