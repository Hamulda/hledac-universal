...
class GenerationFacade:
    ...
    def set_model_accessors(self, model_getter: Any, tokenizer_getter: Any) -> None:
    ...
    async def generate_stream(
        ...
        Cleanup:
            - Ensures handler is properly closed on early exit
    ...
    async def _run_mlx_generate(self, model: Any, tokenizer: Any, kwargs: dict[str, Any]) -> str:
