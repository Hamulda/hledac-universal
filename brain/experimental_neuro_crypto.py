...
# EXPERIMENTAL: Not security-reviewed. SNN-based cryptography, research only.
# Enable: HLEDAC_ENABLE_NEURO_CRYPTO=1
if not os.getenv("HLEDAC_ENABLE_NEURO_CRYPTO"):
    raise ImportError(
        "NeuromorphicCryptoEngine requires HLEDAC_ENABLE_NEURO_CRYPTO=1. "
        "This module is EXPERIMENTAL and has not been security-reviewed."
    )
