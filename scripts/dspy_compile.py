...
OSINT_DARK_QUERY_TRAINSET = [
    ...
    dspy.Example(
        ...
        dark_queries=[{"type": "onion", "query": "ahmia search 8.8.8.8"}, {"type": "i2p", "query": "I2P search 8.8.8.8"}]  # noqa: E501
    ...
    dspy.Example(
        ...
        dark_queries=[{"type": "onion", "query": "ahmia 185.220.101.42"}, {"type": "paste", "query": "pastebin 185.220.101.42"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ioc_brief="IP 45.33.32.156 — static hole in traceroute",
        available_transports="tor+stealth", max_queries=4,
        dark_queries=[{"type": "onion", "query": "ahmia 45.33.32.156 BGP"}, {"type": "i2p", "query": "I2P 45.33.32.156"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    ...
    dspy.Example(
        ...
        dark_queries=[{"type": "onion", "query": "ahmia search evil-domain.ru mirror"}, {"type": "onion", "query": "to料的 evil-domain.ru"}, {"type": "paste", "query": "pastebin evil-domain.ru C2"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ioc_brief="Domain moonlighting-market.ru — suspected marketplace",
        available_transports="tor+stealth", max_queries=6,
        dark_queries=[{"type": "onion", "query": "ahmia moonlighting-market.ru"}, {"type": "i2p", "query": "I2P moonlighting-market.ru"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ioc_brief="Domain protonmail3xxx.onion — unknown hidden service",
        available_transports="tor", max_queries=4,
        dark_queries=[{"type": "onion", "query": "ahmia protonmail3xxx.onion"}, {"type": "i2p", "query": "I2P search protonmail"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ioc_brief="Domain example-login-portal.com — credential harvest site",
        available_transports="tor+stealth", max_queries=5,
        dark_queries=[{"type": "onion", "query": "ahmia example-login-portal.com phishing"}, {"type": "paste", "query": "pastebin example-login-portal.com"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    # hash → IPFS CID lookup
    dspy.Example(
        ioc_brief="Hash sha256:4a5f8c3d...e1b9 — found in GitHub leak",
        available_transports="tor+stealth", max_queries=6,
        dark_queries=[{"type": "ipfs", "query": "IPFS CID 4a5f8c3d hash"}, {"type": "onion", "query": "ahmia 4a5f8c3d data leak"}, {"type": "paste", "query": "pastebin 4a5f8c3d"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ioc_brief="Hash md5:b19a... — shared credential from breach",
        available_transports="tor+stealth", max_queries=4,
        dark_queries=[{"type": "ipfs", "query": "IPFS CID b19a md5 breach"}, {"type": "paste", "query": "pastebin md5 b19a breach"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
    ...
    dspy.Example(
        ...
        available_transports="tor+stealth", max_queries=8,
        dark_queries=[{"type": "onion", "query": "ahmia CVE-2024-1701 exploit"}, {"type": "onion", "query": "to料的 CVE-2024-1701"}, {"type": "paste", "query": "pastebin CVE-2024-1701"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ioc_brief="CVE-2023-44487 — HTTP/2 Rapid Reset DOStream",
        available_transports="tor+stealth", max_queries=6,
        dark_queries=[{"type": "onion", "query": "ahmia CVE-2023-44487"}, {"type": "paste", "query": "pastebin CVE-2023-44487"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ioc_brief="CVE-2021-44228 — Log4Shell — active exploitation in wild",
        available_transports="tor+stealth", max_queries=10,
        dark_queries=[{"type": "onion", "query": "ahmia log4j shell"}, {"type": "onion", "query": "to料的 log4j"}, {"type": "paste", "query": "pastebin log4j RCE"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    # mixed IOC cluster
    dspy.Example(
        ioc_brief="Cluster: IP 192.168.1.1, domain evil.ru, hash abc123...",
        available_transports="tor+stealth", max_queries=7,
        dark_queries=[{"type": "onion", "query": "ahmia evil.ru 192.168.1.1"}, {"type": "ipfs", "query": "IPFS abc123"}, {"type": "paste", "query": "pastebin abc123 evil.ru"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ioc_brief="Domain leaksploit.xyz — exploit kit landing page",
        available_transports="tor+stealth", max_queries=6,
        dark_queries=[{"type": "onion", "query": "ahmia leaksploit.xyz"}, {"type": "paste", "query": "pastebin leaksploit.xyz"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    # email → breach/paste lookup
    dspy.Example(
        ioc_brief="Email victim@company.com — found in LinkedIn scrape",
        available_transports="tor+stealth", max_queries=5,
        dark_queries=[{"type": "paste", "query": "pastebin victim@company.com breach"}, {"type": "onion", "query": "ahmia victim@company.com"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    dspy.Example(
        ioc_brief="Email admin@shellcorp.net — credential in dark paste",
        available_transports="tor+stealth", max_queries=4,
        dark_queries=[{"type": "paste", "query": "pastebin admin@shellcorp.net"}, {"type": "onion", "query": "ahmia shellcorp.net"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    ...
    dspy.Example(
        ...
        available_transports="tor+stealth", max_queries=6,
        dark_queries=[{"type": "onion", "query": "ahmia suspect-portal.ru phishing"}, {"type": "paste", "query": "pastebin suspect-portal.ru"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
    # wallet → crypto tracer dark ops
    dspy.Example(
        ioc_brief="BTC address bc1qxy2kgp... — ransomware payment address",
        available_transports="tor+stealth", max_queries=5,
        dark_queries=[{"type": "onion", "query": "ahmia bc1qxy2kgp ransomware"}, {"type": "paste", "query": "pastebin bc1qxy2kgp"}]  # noqa: E501
    ).with_inputs("ioc_brief", "available_transports", "max_queries"),
]
