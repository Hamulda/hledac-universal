...
class TemporalGap(Struct, frozen=True):
...
class EntityTimeline(Struct, frozen=True):
...
class TemporalAnomaly(Struct, frozen=True):
...
class TemporalCorrelation(Struct, frozen=True):
...
class RecoveryResult(Struct, frozen=True):
