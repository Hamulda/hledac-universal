...
_LAZY_SPECS: tuple[tuple[str, str, tuple[str, ...], tuple[str, ...]], ...] = (
    ...
    (
        ".temporal_archaeologist_adapter",
    ...
    (
        ".translinguistic_normalizer",
        "TRANSLINGUISTIC_NORMALIZER_AVAILABLE",
        (
            "normalize_translinguistic",
            "normalize_cyrillic",
            "normalize_arabic",
            "normalize_cjk",
            "normalize_greek",
            "normalize_hebrew",
            "normalize_multilingual_name",
            "double_metaphone",
            "batch_normalize_translinguistic",
    ...
    (
        ...
        (
            ...
            "UTXOEdge",
            "ChangeAddressResult",
            "analyze_bitcoin_transactions",
            "cluster_bitcoin_addresses",
        ),
        (),
    ),
...
__all__ = sorted(
    {
        ...
        "IPFSClient",
        "GitHubHistoricalClient",
        "CDXSnapshot",  # WaybackCDXClient removed in F350M-R
        "DiscoveredEndpoint",
        "search_archives",
        "get_wayback_snapshots",
        "discover_from_wayback",
