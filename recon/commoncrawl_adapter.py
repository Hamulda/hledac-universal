...
class CCSearchResult:
    ...
    def to_canonical_finding(self, query: str, _sprint_id: str='') -> CanonicalFinding | None:
        ...
        try:
            ...
            return CanonicalFinding(finding_id=finding_id, query=query, source_type=_SOURCE_TYPE, confidence=0.45, ts=ts, provenance=(_SOURCE_TYPE,), payload_text=payload_text, accepted=True, reason=None, entropy=0.0, normalized_hash=None, duplicate=False)
...
class CommonCrawlAdapter:
    ...
    """
    __slots__ = ('_stats', '_last_request', '_request_count', '_rate_limited', '_bloom')
