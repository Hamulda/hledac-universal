...
class SecurityLayer:
        ...
        try:
            if self._string_obfuscator:
                ...
                return ObfuscationResult(
                    ...
                    decoy_count=self.config.decoy_count if level in (
    ...
    def generate_chaff(self, count: int | None = None) -> list[str]:
        ...
        fallback_chaff = [
            'weather forecast today', 'healthy dinner recipes',
            'how to meditate', 'best programming tutorials',
            'latest science discoveries', 'workout routines',
            'productivity tips', 'travel destinations 2024',
            'book recommendations', 'time management techniques',
        ]
