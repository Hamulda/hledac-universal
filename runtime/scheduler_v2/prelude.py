...
async def run_ct_prelude_lane(
    ...
    try:
        ...
        # Lazy import: _get_ct_adapter is in runtime/scheduler/lanes/__init__.py
        ...
        _bridge_result = ct_results_to_findings(
            ...
            _ct_outcome,
            query,
            sprint_id=f"prelude-ct-{int(_time.time())}",
        )
...
async def run_wayback_prelude_lane(
    ...
    if _wb_query and not isinstance(_wb_query, dict):
        ...
        return LaneResult(
            ...
            attempted=True,
            skipped=False,
            built_count=len(_wb_cands),
            accepted_count=_wb_acc,
        )
...
async def run_pdns_prelude_lane(
    ...
    if _pdns_query and not isinstance(_pdns_query, dict):
        ...
        return LaneResult(
            ...
            attempted=True,
            skipped=False,
            built_count=len(_pdns_cands),
            accepted_count=_pdns_acc,
        )
...
async def run_doh_prelude_lane(
    ...
    result.doh_planned = is_lane_enabled(None, AcquisitionLane.DOH)  # type: ignore
    result.doh_scheduled = True

    # F220J: Prefer domain seed from pivot plan
    ...
    try:
        ...
        if _doh_findings:
            ...
            return LaneResult(
                ...
                attempted=True,
                skipped=False,
                built_count=len(_doh_cands),
                accepted_count=_doh_acc,
            )
