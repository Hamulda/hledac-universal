...
class AcquisitionContext:
    ...
    query: str
    uma_state: str  # "ok" | "warn" | "critical" | "emergency"
    swap_detected: bool
    duration_s: float
    aggressive_mode: bool
    plan: Any = None  # AcquisitionStrategySnapshot | None
    transport_authority_status: Any = None  # dict | None
    stealth_phase: Any = None  # dict | None
