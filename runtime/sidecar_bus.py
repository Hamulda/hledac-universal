...
try:
    ...
    _SourceType = None  # type: ignore[assignment]
import logging
...
async def _embedding_runner(
    ...
    try:
        ...
        _sidecarlogger.debug(
            "embedding_runner: exception during embed: %s: %s",
            type(exc).__name__,
            exc,
        )
    return None
...
_LeakSentinelRunner = sidecar_runner(
    name="leak_sentinel",
    module_path="hledac.universal.intelligence.leak_sentinel",
...
_TemporalArchaeologyRunner = sidecar_runner(
    ...
    module_path="hledac.universal.intelligence.temporal_archaeologist_adapter",
...
_PassiveFingerprintRunner = sidecar_runner(
    ...
    module_path="hledac.universal.intelligence.passive_fingerprint",
...
_RirCorrelatorRunner = sidecar_runner_await(
    name="rir_correlator",
    module_path="hledac.universal.intelligence.rir_correlator",
