...
with open("/Users/vojtechhamada/PycharmProjects/Hledac/hledac/universal/recon/identity_stitching.py") as f:
    source = f.read()
...
with open("/Users/vojtechhamada/PycharmProjects/Hledac/hledac/universal/recon/document_intelligence.py") as f:
    source = f.read()
